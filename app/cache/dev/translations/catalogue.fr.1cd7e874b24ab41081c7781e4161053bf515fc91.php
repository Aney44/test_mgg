...
',
  ...
  array (
    ...
    'help.app_description' => 'C\'est une <strong>application de démonstration</strong> construite avec le framework Symfony pour illustrer la façon recommandée de développer des applications Symfony.',
    'help.show_code' => 'Cliquez sur ce button pour voir le code source du <strong>contrôleur</strong> et du <strong>template</strong> utilisé pour afficher cette page.',
    'help.browse_app' => 'Parcourir la <strong>section publique</strong> de l\'application de démonstration.',
    'help.browse_admin' => 'Parcourir l\'<strong>administration</strong> de l\'application de démonstration.',
    'help.login_users' => 'Essayez l\'un des utilisateurs suivants',
    'help.role_user' => 'utilisateur normal',
    'help.role_admin' => 'administrateur',
    'help.reload_fixtures' => 'Si ces utilisateurs ne fonctionnent pas, rechargez les fixtures de l\'application en exécutant cette commande depuis le terminale :',
