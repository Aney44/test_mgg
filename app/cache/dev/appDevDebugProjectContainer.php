...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'AcmeApiClientBundle', ($this->targetDirs[2].'/Resources/AcmeApiClientBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'AcmeApiClientBundle', ($this->targetDirs[3].'/src/Acme/ApiClientBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_48430ab98e2ff969958d1a93cb97c75d95b9c72d59565e3b6e858d457d150292');
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $this->get('fos_user.user_provider.username')), 'main', $b, $c), 2 => $g, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($a, $f, $this->get('security.authentication.session_strategy'), $d, 'main', $h, $i, array('check_path' => '/login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'post_only' => true), $b, $c, $this->get('security.csrf.token_manager')), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '581b94e156e473.63688887', $b, $f), 5 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $d, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $d, '/login', false), NULL, NULL, $b, false));
    }
    ...
    {
        $a = new \Sp\BowerBundle\Bower\Configuration(($this->targetDirs[3].'/src/Acme/ApiClientBundle/Resources/config/bower'));
        $a->setAssetDirectory(($this->targetDirs[3].'/src/Acme/ApiClientBundle/Resources/config/bower/../../public/components'));
        $a->setJsonFile('bower.json');
        $a->setEndpoint('https://bower.herokuapp.com');
        $a->setCache(new \Doctrine\Common\Cache\FilesystemCache(($this->targetDirs[3].'/src/Acme/ApiClientBundle/Resources/config/bower/../../public/components/cache'), '.sp_bower.data'));

        $this->services['sp_bower.bower_manager'] = $instance = new \Sp\BowerBundle\Bower\BowerManager();

        $instance->addBundle('AcmeApiClientBundle', $a);
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), false, array(), array(0 => 'AcmeBlogBundle', 1 => 'AcmeApiClientBundle'), new \Symfony\Bundle\AsseticBundle\DefaultValueSupplier($this)));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/Acme/ApiClientBundle/Resources/views'), 'AcmeApiClient');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'AcmeApiClientBundle' => 'Acme\\ApiClientBundle\\AcmeApiClientBundle',
